...
class PoseEstimator:
    ...
    def solve_pose_by_68_points(self, image_points, frontal_camera=True):
        """
        Solve pose from all the 68 image points
        Return (rotation_vector, translation_vector) as pose.
        """
        camera_angle = self.model_points_68 if frontal_camera is True else self.model_points_68_selective
